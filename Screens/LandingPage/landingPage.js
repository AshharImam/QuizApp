        ...
        <SafeAreaView style={{ flex: 1, padding: 10 }}>
          ...
          <ScrollView>
            ...
            <View style={{}}>
              ...
              <TouchableOpacity
                onPress={() =>
                  this.props.navigation.navigate("ByDomainTestScreen")
                }
                style={{
                  backgroundColor: "rgba(0,0,0,0.4)",
                  padding: 3,
              ...
              >
                <View style={{ flex: 1 }}>
                  <Text style={{ color: "white", fontSize: 18 }}>
                    By Domain - People, Process & Business Environment
                  </Text>
                </View>
                <AntDesign
                  name="playcircleo"
              ...
              >
                <TouchableOpacity
                  onPress={() =>
                    this.props.navigation.navigate("StudentReviewsScreen")
                  }
                  style={{ padding: 10 }}
                >
                  <Text
                ...
                >
                  "PMP", "PMBOK", "PMI-ACP", "PgMP" and "CAPM" are registered
                  marks of the Project Management Institue, Inc.
                </Text>
