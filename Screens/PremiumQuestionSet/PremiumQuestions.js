        ...
        >
          ...
          >
            ...
            <View>
              ...
              <Text style={{ color: "rgb(100,198,247)" }}>200 Questions</Text>
            </View>
            {/* <AntDesign name="playcircleo" size={24}  /> */}
          </TouchableOpacity>
          <TouchableOpacity
            onPress={() => this.payment(2)}
            style={{
              marginVertical: "1%",
              backgroundColor: "rgba(0,0,0,0.4)",
              padding: "2%",
